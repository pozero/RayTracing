...
vk::Instance create_instance(std::span<const char*> inst_ext,
    ...
    VK_CHECK(result, ret, vk::createInstance(instance_info));
...
std::tuple<vk::Device, vk::PhysicalDevice, VulkanQueues>
    ...
    VulkanQueues ret_queues{};
    std::vector<vk::PhysicalDevice> phy_devs{};
    VK_CHECK(result, phy_devs, inst.enumeratePhysicalDevices());
